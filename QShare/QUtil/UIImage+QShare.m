                ...
                interpolationQuality:(CGInterpolationQuality)quality
{
    ...
    return [self QShare_resizedImage:newSize
                               transform:[self QShare_transformForOrientation:newSize]
...
// image
- (CGAffineTransform)QShare_transformForOrientation:(CGSize)newSize
{
